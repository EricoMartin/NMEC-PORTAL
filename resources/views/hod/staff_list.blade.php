...
<br>
  ...
  @endif  
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('HOD Dashboard') }}</div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><a class="btn btn-primary" href="<?php echo e(url('/hod/'.$staff_list->user_id.'/message')); ?>" >Message {{$staff_list->lastname}}</a>
                                </td>
                                <td><a class="btn btn-primary" href="<?php echo e(url('/hod/'.$staff_list->user_id.'/staff')); ?>" >view Data</a></td>
                              </tr>
                            </tbody>
                          </table>
                        @endforeach
